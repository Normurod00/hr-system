...
.skills-modal__group-title:first-child {
    margin-top: 0;
}
...
<div class="skills-modal-overlay" id="skillsModalOverlay">
    <div class="skills-modal">
        <div class="skills-modal__header">
            ...
            <button type="button" class="skills-modal__close" id="skillsModalClose">
