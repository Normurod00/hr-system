        ...
        <div class="col-lg-8">
            <div class="card shadow-sm" style="height: calc(100vh - 160px); display: flex; flex-direction: column;">
                ...
                <div class="card-header d-flex align-items-center gap-3">
                    <a href="{{ route('employee.staff-chat.index') }}" class="btn btn-sm btn-outline-secondary">
                        <i class="bi bi-arrow-left"></i>
                    </a>
                    <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold text-white"
                         style="width:40px;height:40px;background:linear-gradient(135deg,#3B82F6,#60A5FA);">
                        {{ mb_strtoupper(mb_substr($chat->hr->name, 0, 1)) }}
                    </div>
                    <div>
                        <h6 class="mb-0">{{ $chat->hr->name }}</h6>
